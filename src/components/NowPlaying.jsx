...
import { loadMovies } from "../redux/actions/nowPlayingMoviesActionCreator";
import { loadMovie } from "../redux/actions/selectedMovieActionCreator";
import { Link } from "react-router-dom";

const PopularMovies = () => {
    const dispatch = useDispatch();
    const movies = useSelector((state) => state.nowPlayingMovies);
    ...
    return (
        ...
        <div className="popular--movies--section">
                <div className="popular__movies__title">
                    <h1>Actualmente en las mejores salas</h1>
                </div>
